...
This is where React Native comes in. The JavaScript/native interface, advanced bundling techniques, and a component-based architecture provide the baseline requirements for creating a workflow that is fast in development and *optimized* for production.
...
![Navigation is truly native and optimized for iOS and Android](./images/1pIlbQ1TbALbsTKH-ibhYOA.png)*Navigation is truly native and optimized for iOS and Android*
...
![React Error Boundaries can be nested in layouts enabling users to navigate away or retry the page.](./images/1wCKlTNGpkSBU0Uktj6HVmA.png)*React Error Boundaries can be nested in layouts enabling users to navigate away or retry the page.*
...
![No boilerplate needed! Apps now have multiple static entry points which makes it possible for tooling to reason about the structure of your app and make optimizations behind the scenes.](./images/1Q-94OUpmJoae0HBu0Mti7A.gif)*No boilerplate needed! Apps now have multiple static entry points which makes it possible for tooling to reason about the structure of your app and make optimizations behind the scenes.*
...
![app/home.js](./images/1YUNNVfUJvCV8xHgNplFR4Q.png)*app/home.js*

Then a navigation file:

![./App.js](./images/1KBT-K8gZZOn3r8fKKXEjgQ.png)*./App.js*

Finally create an entry file for registering the root componet:

![index.js](./images/1u-kVuwo2xKn2zs_DJ59yhA.png)*index.js*
...
You can start the app with `npx expo start` and visit the `/home` route on any device. I recommend using `[uri-scheme`](https://www.npmjs.com/package/uri-scheme) to test deep links on iOS and Android. You can also navigate to `/__index` to reach the sitemap (development only):

![Apache index throwback](./images/1iNCWIvukczHDJKPYsAFx-A.png)*Apache index throwback*
...
![Virtual pages have a recurring theme.](./images/1gWG4Lvi9bcp-yyDVEi4jbw.png)*Virtual pages have a recurring theme.*
