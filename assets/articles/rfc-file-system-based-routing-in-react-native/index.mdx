...
> **\*TL;DR:** The new library Expo Router is a work in progress, join the [discussion on GitHub](https://github.com/expo/router/discussions/1)! Refer to the [\*\*Expo Router documentation](https://expo.github.io/router) \*_to get started and learn more._
...
![app/home.js](./images/1YUNNVfUJvCV8xHgNplFR4Q.png)_app/home.js_

Then a navigation file:

![./App.js](./images/1KBT-K8gZZOn3r8fKKXEjgQ.png)_./App.js_

Finally create an entry file for registering the root componet:

![index.js](./images/1u-kVuwo2xKn2zs_DJ59yhA.png)_index.js_
