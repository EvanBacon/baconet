...
<Embed url="https://snack.expo.io/embedded/@bacon/firebase-basic-chat" />
...
2. Create a `Text` element that tell's our user what to do.
3. Build a Button by adding a Text and wrapping it in a TouchableOpacity. Then assign the onPress to this.onPress, we'll create that in a second.
4. Make the title stile, add some margin and give it a nice large font
5. Create a style for the button text
...
<Embed url="https://snack.expo.io/@bacon/firebase-basic-chat" />
